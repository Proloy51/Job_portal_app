                                    ...
                                    if(task.isSuccessful()){
                                        ...
                                        TimerTask timerTask = new TimerTask() {
                                            ...
                                            public void run() {
                                                ...
                                                if(count == 30){
                                                    timer.cancel();
//                                                     Toast.makeText(JobSeekerSignup.this, "Registration is successful", Toast.LENGTH_SHORT).show();
                                                    databaseReference.child("JobSeeker").child(user).child("First Name").setValue(fName);
                                                    databaseReference.child("JobSeeker").child(user).child("Last Name").setValue(lName);
                                                    ...
                                                    Intent intent = new Intent(JobSeekerSignup.this,JobSeekerHomePage.class);
