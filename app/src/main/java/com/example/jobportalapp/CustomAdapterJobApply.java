...
public class CustomAdapterJobApply extends ArrayAdapter<Job> {
    private Activity context;
    private List<Job> jobList;

    public CustomAdapterJobApply(Activity context, List<Job> jobList) {
        super(context, R.layout.itemapply, jobList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = layoutInflater.inflate(R.layout.itemapply,null,true);
